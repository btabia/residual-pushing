...
class ArmSim(BasePybulletEnv):
    ...
    def _load_robot_with_rod(self):
        ...
        for i in range(6):
            self._p.changeDynamics(self.robot_arm_id, i, lateralFriction=10.0, spinningFriction=10.0,
                                   rollingFriction=0.0001, restitution=0.00001, jointLimitForce=150)
