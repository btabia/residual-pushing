...
class CurriculumCallback(BaseCallback):
    ...
    def _on_training_start(self):
        self.training_env.max_curriculum_iteration_steps = len(self.curriculum_iteration_steps)

    def _on_step(self) -> bool:
        self.evaluation_env.curriculum_difficulty = self.training_env.curriculum_difficulty
        ...
        if self.n_calls == self.curriculum_iteration_steps[self.current_curriculum_step]:
            self.training_env.change_curriculum_difficulty = True
