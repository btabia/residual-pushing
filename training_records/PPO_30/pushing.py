...
class Pushing(ArmSim):
    ...
    def get_reward(self):
        ...
        reward_displacement_tolerance = self.cfg["RL"]["reward"]["object_goal_speed_tolerance"] / 3
        reward_distance_tolerance = self.cfg["RL"]["reward"]["object_goal_dist_tolerance"] / 3
