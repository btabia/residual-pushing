...
class Pushing(ArmSim):
    ...
    def _get_observation(self):
        ...
        self.debris_target_dist = np.sqrt(pow(self.debris_target_pos[0] * 10,2) + pow(self.debris_target_pos[1] * 10,2))
    ...
    def get_reward(self):
        ...
        reward_distance = 0 #  reward_dist_weight * (np.exp((-pow(self.debris_target_quad_dist,2))/(2*pow(reward_distance_tolerance,2))))
    ...
    def is_done(self):
        ...
        if self.debris_target_dist < self.target_distance_reach: done = True
        return done
